# Project Forest AWS Infrastructure - ECS/Fargate Configuration
terraform {
...
resource "aws_subnet" "public" {
  count = var.enable_high_availability ? 2 : 1
...
# NAT Gateway (conditional for development)
...
# CloudFront Distribution (optional for development)
